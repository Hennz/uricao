...
{
    public class ComandoConsultarEntreFechas : Comando<List<Entidad>>
    {
        private string _fechaInicio;
        private string _fechaFin;
         public ComandoConsultarEntreFechas()
        {
        }

         public ComandoConsultarEntreFechas(string fechaInicio, string fechaFin)
        {
