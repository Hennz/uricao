...
{
    public class ComandoEliminarTratamiento : Comando<bool>
    {
        Entidad _tratamientoPrimario;



        public ComandoEliminarTratamiento(Entidad tratamientoPrimario)
        {
        ...
        public override bool Ejecutar()
        {
            try
            {
                ...
                return FabricaDAO.CrearFabricaDeDAO(1).CrearDAOTratamiento().SqlActivarDesactivarTratamiento(this._tratamientoPrimario);
            }
