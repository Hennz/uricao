...
{
    public class ComandoModificarHistoriaClinica : Comando<bool>
    {
       private Entidad _historiaClinica;

        public ComandoModificarHistoriaClinica(Entidad historiaClinica)
        {
        ...
        public override bool Ejecutar()
        {
            try
            {
                return FabricaDAO.CrearFabricaDeDAO(1).CrearDAOHistoriaClinica().ModificarHistoriaClinica(_historiaClinica);
            }
