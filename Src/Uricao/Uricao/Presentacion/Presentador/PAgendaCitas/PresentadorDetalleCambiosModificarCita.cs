...
{
    public class PresentadorDetalleCambiosModificarCita
    {

                #region Atributos

        private IContratoDetalleCambiosModificarCita _vista;
        ...
        public PresentadorDetalleCambiosModificarCita(IContratoDetalleCambiosModificarCita _vista)
        {
            this._vista = _vista;
        }
