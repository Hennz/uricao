...
{
    public class PresentadorModificarCita
    {

                #region Atributos

        private IContratoModificarCita _vista;
        ...
        public PresentadorModificarCita(IContratoModificarCita _vista)
        {
            this._vista = _vista;
        }
        ...
        {
            ///////////////////////////////Arreglar esto///////////////////////////////////////
            ComandoConsultarListaTratamientos comandoTratamientos = FabricaComando.CrearComandoConsultarListaTratamientos();
            listaTratamiento = comandoTratamientos.Ejecutar();        
        }
        ...
        public String RowCommandGridView(String comando, object indiceFila)
        {
            if (comando == "Modificar")
            {
                ...
                return "DetalleModificarCita.aspx?fecha=" + fecha + "&horai=" + horai + "&horaf=" + horaf + "&nombre=" + nombre + "&apellido=" + apellido + "&tratamiento=" + tratamiento;
            }
