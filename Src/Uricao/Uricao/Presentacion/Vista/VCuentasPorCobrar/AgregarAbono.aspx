<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/MasterPage/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="AgregarAbono.aspx.cs" Inherits="Uricao.Presentacion.PaginasWeb.PCuentasPorCobrar.AgregarAbono" %>
    ...
    <div style="float:left;">
      <fieldset style="width:740px; height:210px; margin:0px auto 0px auto;">
           ...
           <table style="margin:0px auto 0px auto; height: 160px;" cellspacing="5px" border="0"  cellpadding="0" >
                ...
                <tr>
                    <td>
                        <asp:Label ID="datosabono" runat="server" Text="Datos Abono:"></asp:Label>
                    </td>
                    <td>
