<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/MasterPage/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="DetalleFactura2.aspx.cs" Inherits="Uricao.Presentacion.PaginasWeb.PCuentasPorCobrar.DetalleFactura2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <fieldset style="width:740px; height:50px; margin:0px auto 0px auto; text-align:center;">
            ...
            <asp:LinkButton ID="LinkButton1" href="/Presentacion/PaginasWeb/PCuentasPorCobrar/AgregarAbono2.aspx" runat="server">Agregar Nuevo Abono</asp:LinkButton>
           </fieldset>
