<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/MasterPage/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="ConsultarCuentasPorPagar1.aspx.cs" Inherits="Uricao.Presentacion.PaginasWeb.PCuentasPorPagar.ConsultarCuentasPorPagar1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="superior" style="height:30px;">
        <h2>
           Consultar en una Cuenta por Pagar
        </h2> 
    ...
    <legend>Buscar el detalle de la Cuenta Por Pagar:</legend>
