<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/MasterPage/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="DetalleModificarCita.aspx.cs" Inherits="Uricao.Presentacion.PaginasWeb.PAgendaCitas.DetalleModificarCita" %>
        ...
        <legend>Detalle Cita</legend>        
            ...
            <tr>
             ...
             <tr >
                ...
                <asp:Button ID="aBConfirmar" runat="server" Text="Confirmar Cita" CssClass="button" 
                        onclick="aBConfirmar_Click" Height="27px" Width="110px"/>
                </td>
                ...
                <asp:Button ID="aBModificarDetalles" runat="server" Text="Modificar Cita" CssClass="button" 
                        onclick="aBModificarDetalles_Click" Height="27px" Width="110px"/>
                </td>
                ...
                <asp:Button ID="aBCancelar" runat="server" Text="Cancelar Cita" CssClass="button" 
                        onclick="aBCancelar_Click" Height="27px" Width="110px"/>
                </td>
                  </tr>
