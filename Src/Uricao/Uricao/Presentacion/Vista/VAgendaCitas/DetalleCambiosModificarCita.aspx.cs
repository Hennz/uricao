...
{
    public partial class DetalleCambiosModificarCita : System.Web.UI.Page, IContratoDetalleCambiosModificarCita
    {


        #region Atributos
            private PresentadorDetalleCambiosModificarCita _presentador;
        ...
        public DetalleCambiosModificarCita()
        {
            _presentador = new PresentadorDetalleCambiosModificarCita(this);
        }
        ...
        {
            String direccionRedirigir = "DetalleFinalModificarCita.aspx";
