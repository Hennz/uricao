<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/MasterPage/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="ModificarCitaConsulta.aspx.cs" Inherits="Uricao.Presentacion.PaginasWeb.PAgendaCitas.ModificarCitaConsulta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <fieldset style="width:740px; height:260px; margin:0px auto 0px auto;">
        <legend>Consulta de citas a modificar</legend>        
         ...
         <asp:GridView ID="gridViewCitasDisponibles" runat="server" AllowPaging="True"  
            ...
            GridLines="None" Height="50px" HorizontalAlign="Center" >
                        ...
                        <RowStyle BackColor="#EFF3FB" />
                         ...
                         <Columns>
                         <asp:ButtonField HeaderText ="Modificar" CommandName="Modificar" ButtonType="image" ImageUrl="~/Presentacion/Imagenes/Editar.png"  />
