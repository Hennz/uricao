<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/MasterPage/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="ModificarTratamientoDetalle.aspx.cs" Inherits="Uricao.Presentacion.PaginasWeb.PTratamientos.ModificarTratamientoDetalle" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 <br />
     <fieldset style="width:700px; margin-left:2%;">
    <legend>Agregar Tratamiento</legend>
    <asp:Label ID="error" runat="server" CssClass="falla" Font-Bold="True"></asp:Label>
    <asp:Wizard ID="Agregar" runat="server" DisplaySideBar="False" Height="402px" 
         ActiveStepIndex="1" 
...
<StepPreviousButtonStyle CssClass="button"></StepPreviousButtonStyle>
    <WizardSteps>
        <asp:WizardStep ID="WizardStep1" runat="server" Title="Paso 1">
            ...
            <br />
            <br />
            Imagen: <asp:FileUpload ID="ImagenT" runat="server" CssClass="button"/>
            <br /><br /><br />
            Descripción*:&nbsp;&nbsp;&nbsp;&nbsp;<br />
            ...
            <asp:TextBox ID="Explicacion" runat="server" Height="90px" Width="500px" TextMode="MultiLine"></asp:TextBox>
            <br /><br /><br /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <legend>Asociar Productos</legend>
            <br />
            <br />
            <asp:Label ID="mensajeproductos" runat="server"></asp:Label>
                ...
                <tr>
                    <td rowspan="2">
                        ...
                        <asp:ListBox ID="ProductoSAsociado" runat="server" Height="280px" 
                            Width="240px" OnSelectedIndexChanged="ProductoSAsociado_SelectedIndexChanged"></asp:ListBox>
                    </td>
                    <td>
                    ...
                    <td rowspan="2">
                        ...
                        <asp:ListBox ID="ProductoAsociado" runat="server" Height="280px" 
                            Width="240px" 
                            OnSelectedIndexChanged="ProductoAsociado_SelectedIndexChanged"></asp:ListBox>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        ...
                        <asp:ListBox ID="TratamientoSAsociado" runat="server" Height="280px" 
                            Width="240px"
                            OnSelectedIndexChanged="TratamientoSAsociado_SelectedIndexChanged"></asp:ListBox>
                    </td>
                    <td>
