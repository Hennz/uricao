<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/MasterPage/PaginaMaestra.Master"
    AutoEventWireup="true" CodeBehind="HomeInventario.aspx.cs" Inherits="Uricao.Presentacion.PaginasWeb.PProductosInventario.HomeInventario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
        ...
        <asp:GridView ID="GridConsultar" runat="server" AllowPaging="True" HorizontalAlign="Center"
            ...
            PageSize="8" SelectedIndex="0" Width="720px" CellPadding="4" ForeColor="#333333"
