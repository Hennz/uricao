<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/MasterPage/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="Activa-DesactivarPrivilegios.aspx.cs" Inherits="Uricao.Presentacion.PaginasWeb.PRolesUsuarios.RolesPrivilegios.Activa_DesactivarPrivilegios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div  style="float:left;">
        ...
        <legend>Activar/Desactivar Privilegios</legend>        
            <table style="margin:5% auto auto 26%;" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="Label">Nombre del Priviledio:</asp:Label>
                </td>
                <td>
