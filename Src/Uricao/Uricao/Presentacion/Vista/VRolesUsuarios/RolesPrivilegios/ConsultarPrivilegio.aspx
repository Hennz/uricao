<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/MasterPage/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="ConsultarPrivilegio.aspx.cs" Inherits="Uricao.Presentacion.PaginasWeb.PRolesUsuarios.RolesPrivilegios.ConsultarPrivilegio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div  style="float:left;">
        ...
        <legend>Consultar Privilegios   </legend>        
            ...
            <Columns>
                <asp:CommandField AccessibleHeaderText="Seleccion" ButtonType="Image" 
                    HeaderText="Buscar" EditImageUrl="~/Presentacion/Imagenes/Buscar.png" 
                    ShowEditButton="True" />
            </Columns>
